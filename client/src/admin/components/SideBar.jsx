...
export const SideBar = () => {
  ...
  useEffect(() => {
    if (Array.isArray(ventas)) {
      const ventasPend = ventas.filter(
        (el) => el.estado === "Pendiente"
      ).length;
      setVentasPendientes(ventasPend);
    }
  }, [ventas]);

  useEffect(() => {
    if (Array.isArray(productos)) {
      const producto = productos.filter((el) => el.stock < 10).length;
      setProductosStockCritico(producto);
    }
  }, [productos]);
          ...
          <ul className="space-y-2 font-medium">
              ...
              >
                ...
                >
                  ...
                  <path
                    ...
                    strokeMiterlimit={10}
                    strokeWidth={2}
                    d="M19 41l-7 18h6l10-18M43 17v24M36 41V17"
                  />
                </svg>
                ...
                {productosStockCritico === 0 ? (
                  ...
                  <span className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-red-800 bg-red-100 rounded-full dark:bg-red-800 dark:text-red-300">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Ver web</span>
              </Link>
            </li>
            <li>
              <button
